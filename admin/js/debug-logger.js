...
(function(window) {
    ...
    const MODULE_STYLES = {
        'Auth': 'background: #0ea5e9; color: #0b0f19; font-weight: bold; padding: 2px 6px; border-radius: 4px;',
        ...
        'GitHub': 'background: #2563eb; color: #ffffff; font-weight: bold; padding: 2px 6px; border-radius: 4px;',
